...
echo Choose 1 transaction of wallet (A) [SIGNED] KHÔNG PHẢI [INVOLVED]
...
if defined var (echo Error 1: Wrong syntax, try again... && color 4F && timeout 3 && goto :miniSendCurrency)
...
if "%_chinhSua%" gtr "7" (echo Error 2: The value exceeds [7], try again... && color 4F && timeout 10 && goto :miniSendCurrency)
goto :miniSendCurrency
:BatDauGui
