...
if not exist %_folderVi% (echo No wallet data %_countViStart%, try again ... & timeout 10 & goto :autoCraftLoop1)
set /p "_countViEnd=Wallet end to:"
set _folderVi=%_cd%\user\trackedAvatar\vi%_countViEnd%
if not exist %_folderVi% (echo No wallet data %_countViEnd%, try again ... & timeout 10 & goto :autoCraftLoop1)
:autoCraftLoop2
