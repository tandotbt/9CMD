...
if %_stage% == 0 (echo.Lỗi 1.1: Không tìm thấy stage đã mở & echo.nguyên nhân có thể do node đã chọn hỏng & echo.sử dụng node tiếp theo và thử lại ... & %_cd%\data\flashError.exe & call :changeNode & color 4F & timeout 5 & goto :BatDau)
rem Tạo file cần thiết
